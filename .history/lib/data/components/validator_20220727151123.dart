...
class Validators {
  ...
  String? validConfirmPassword(String? cpass, TextEditingController confirm_password) {
    if (TextControllers().confirmPasswordController.text !=
  ...
  void toggleCheck(bool? val, var check) {
    check = val!;
    print(val);
  }
