...
class RegisterCubit extends Cubit<RegisterState> {
  ...
  checkRegisterButton(GlobalKey<FormState> formKey) async {
    ...
    if (formKey.currentState!.validate()) {
      log("nice");
      RegisterModel newUser = RegisterModel(firstName: TextController().firstNameController, lastName: lastName, email: email, password: password, confirmPassword: confirmPassword, gender: gender, phoneNumber: phoneNumber);
