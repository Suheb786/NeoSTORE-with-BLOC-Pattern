...
class RegisterCubit extends Cubit<RegisterState> {
  ...
  checkRegisterButton(GlobalKey<FormState> formKey) async {
    ...
    if (formKey.currentState!.validate()) {
      log("nice");
      RegisterModel(firstName: firstName, lastName: lastName, email: email, password: password, confirmPassword: confirmPassword, gender: gender, phoneNumber: phoneNumber)
