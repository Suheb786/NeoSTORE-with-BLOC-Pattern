                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      BlocConsumer<RegisterCubit, RegisterState>(
                        ...
                        builder: (context, state) {
                          var registrationModel = RegisterModel(first_name: firfirstNameControllers, last_name: last_name, email: email, password: password, confirm_password: confirm_password, gender: gender, phone_no: phone_no)
                          return CustomButton(
                              navigation: () =>
